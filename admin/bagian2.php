<?php 
    ...
    $query = "SELECT * FROM tamu WHERE kepada LIKE '%2%'";
...
<head>
    ...
    <title>Admin Panel - Bagian2</title> 
</head>
<body>
    <!-- <nav>
        <div class="logo-name">
                      ...
                      <!-- <div align="center">
                        ...
                        <div class="dropdown" align="center">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item text-warning text-center" href="editbag2.php?id=<?= $row['id']?>"><i class="fa-regular fa-pen-to-square"></i> Ubah</a>
    ...
    function SwalDelete(element){
        ...
        Swal.fire({
            ...
            if (result.value) {
                window.location.href = "deletebag2.php?id=" + tamuId;
            }
        })
