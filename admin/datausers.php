            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="datausers.php">
                        <i class="uil uil-user" style="color: #006635;"></i>
                        <span class="link-name" style="color:#006635;">Daftar users</span>
                    </a>
                </li>
                <li>
                    <a href="dataemailtujuan.php">
...
<!-- <script>
        const flasData = $('.flash-dataa').data('flashdataa');
        if (flashData) {
            swal.fire({
                tittle: 'selamat',
                text: flashData + 'Berhasil Diperbarui',
                icon: 'succes',
                showConfirmButton: false,
                timer: 1500
            });
