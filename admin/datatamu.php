...
<head>
    ...
    <title>Admin Panel - Data Tamu</title> 
</head>
<body>
    <nav>
        <div class="logo-name">
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <i class="uil uil-users-alt" style="color: #006635;"></i>
                    <span class="link-name" style="color:#006635;">Daftar tamu</span>
                </a></li>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <div class="print">
                    <button href="print.php" class="btn btn-primary btn-sm">Print Data Tamu</button>
                    </div>
                </div>
                <!-- get session flash -->
    ...
    function SwalDelete(element){
        ...
        Swal.fire({
            ...
            if (result.value) {
                window.location.href = "deletetamu.php?id=" + tamuId;
            }
        })
