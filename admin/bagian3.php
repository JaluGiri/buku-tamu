<?php 
    ...
    $query = "SELECT * FROM tamu WHERE kepada LIKE '%3%'";
...
<head>
    ...
    <title>Admin Panel - Bagian3</title> 
</head>
<body>
                      ...
                      <!-- <div align="center">
                        ...
                        <div class="dropdown" align="center">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item text-warning text-center" href="editbag3.php?id=<?= $row['id']?>"><i class="fa-regular fa-pen-to-square"></i> Ubah</a>
    ...
    function SwalDelete(element){
        ...
        Swal.fire({
            ...
            if (result.value) {
                window.location.href = "deletebag3.php?id=" + tamuId;
            }
        })
